...
@Schema(description = "Request body for creating a new landmark")
public record LandmarkCreateRequest(

        @Schema(description = "Name of the landmark", example = "Pyramids of Giza", required = true)
        String name,

        @Schema(description = "Description of the landmark", example = "Ancient Egyptian pyramid complex")
        String description,

        @Schema(description = "City where the landmark is located", example = "Giza", required = true)
        String city,

        @Schema(description = "Full address of the landmark", example = "Al Haram, Nazlet El-Semman, Giza Governorate")
        String address,

        @Schema(description = "Type of the landmark", example = "MONUMENT", required = true,
